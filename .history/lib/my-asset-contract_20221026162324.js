...
class MyAssetContract extends Contract {
    ...
    async GetResultSecondPriceBid(ctx,myAssetId){
        ...
        //     returnMSG[0] = allResults[0].Record.user;
        //     returnMSG[1] = allResults[0].Record.price;
        //     // returnMSG.push(allResults[0].Record.user,allResults[0].Record.price)
        // }else if (allResults.length > 1){
        //     // a= allResults[0].Record.user;
        //     // returnMSG[0] = allResults[0].Record.user
        //     // returnMSG[1] = allResults[1].Record.price
        // }
        // // else{
        // //     returnMSG = null;
        // // }
